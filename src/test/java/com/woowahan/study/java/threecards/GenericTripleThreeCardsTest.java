...
import static com.woowahan.study.java.threecards.GenericTripleThreeCards.find;
import static org.junit.jupiter.api.Assertions.assertEquals;

class GenericTripleThreeCardsTest
{
    @Test void 단순한_값_반환() throws Exception
    {
        ...
        List<Triple<Integer, Integer, Integer>> result = find(cards, target);
